...
public class MazeViewer extends JPanel {
    ...
    public void init(String[] args) {
        ...
        if (!checkArgs(args)) {
            System.out.println("The single argument needs to be random or bfs");
            System.exit(1);
        }
        //gets command line arg regarding size and generates new Maze with those dimensions
        int size = Integer.parseInt(args[1]);
        maze = new Maze(size, size);
        //establishes this GUI as the viewer of the maze
        maze.setViewer(this);
