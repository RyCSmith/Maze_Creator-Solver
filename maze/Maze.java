 ...
 */
public class Maze {
	private int wallsKnockedDown = 0; //static
    ...
    public synchronized void generateMaze() {
        makeKruskalMaze();
        //you can change the startCell and endCell values here if desired
        startCell = maze[0][0];
    ...
    public synchronized void makeKruskalMaze() {
        ...
        while (wallsKnockedDown < ((rows * cols) - 1)){
        	MazeCell current = maze[generator.nextInt(rows)][generator.nextInt(cols)];
        	MazeCell randomNeighbor = current.getRandomNeighbor();
        	if (randomNeighbor != null){
        		MazeCell currentLeader = djset.find(current);
        		MazeCell neighborLeader = djset.find(randomNeighbor);
        		if (currentLeader != neighborLeader){
        			djset.union(currentLeader, neighborLeader);
        			current.knockDownWall(randomNeighbor);
        			wallsKnockedDown++;
        			visualize(current);
        		}
        	}
     ...
     *  Starts at the <code>startCell</code> and stops when dfs
     *  discovers the <code>endCell</code>.
     */
     ...
     *  Starts at the <code>startCell</code> and stops when bfs
     *  discovers the <code>endCell</code>.
     */
